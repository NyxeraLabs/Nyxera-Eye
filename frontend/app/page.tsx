  ...
  return (
    <div className="flex flex-col gap-6 pb-16">
      <section className="rounded-2xl border border-white/15 bg-white/5 p-6 shadow-glow backdrop-blur">
        <p className="font-mono text-xs uppercase tracking-[0.25em] text-cyan-300">Sprint 18/19/20 Frontend</p>
      ...
      <section className="rounded-2xl border border-white/10 bg-slate-950/55 p-4">
        ...
        <WorldMapLeaflet devices={deviceLocations} events={eventLocations} />
      </section>
    </div>
  );
}
