...
export default function LoginPage() {
  ...
  return (
    <section className="mx-auto mt-20 w-full max-w-md rounded-2xl border border-emerald-300/25 bg-black/45 p-6 shadow-2xl">
      <p className="font-mono text-xs uppercase tracking-[0.26em] text-emerald-300">Nyxera Authentication</p>
      <h1 className="mt-2 text-3xl font-bold text-emerald-100">Operator Login</h1>
